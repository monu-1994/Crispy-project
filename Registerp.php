		...
		<div class="row agileinfo_mail_grids">
			<div class="col-lg-8 agileinfo_mail_grid_right">
				  <form action="#" method="post">
					...
					<ul>
                        Name&nbsp&nbsp:&nbsp&nbsp<input type="text"><br><br>
                        Email&nbsp&nbsp:&nbsp&nbsp<input type="Email"><br><br>
                        Password&nbsp&nbsp:&nbsp&nbsp<input type="Password"><br><br>
                        Mobile No&nbsp&nbsp:&nbsp&nbsp<input type="mobile no"><br><br>
						</ul><br><br>
                   	</div>
