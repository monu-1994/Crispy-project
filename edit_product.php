	...
	<div class="container">
		...
		<nav class="d-lg-flex">
			...
			<ul class="menu mt-2 ml-auto">
                ...
                <li class=""><a href="log out.html">Logout</a></li>
...
<section class="mail pt-lg-5 pt-4">
	<div class="container pt-lg-5">
		<h2 class="heading text-center mb-sm-5 mb-4">Edit Recipe</h2>
		<div class="row agileinfo_mail_grids">
			<div class="col-lg-8 agileinfo_mail_grid_right">
				  <form action="#" method="post">
					  <label><button>Edit RECIPE</button></label>
					<div class="form-input">
						
					<ul>
                        Title&nbsp&nbsp:<input type="text"><br><br>
                        Recipr Description&nbsp&nbsp:<input type="text"><br><br>
                        Price&nbsp&nbsp:<input type="text"><br><br>
                        Image&nbsp&nbsp:<input type="file"><br><br>
						</ul><br><br>
                   	</div>
