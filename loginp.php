				...
				<form action="#" method="post">
					<div class="row">
						<div class="col-md-6 wthree_contact_left_grid pr-md-0">
                            ...
                            Male<input type="Radio" name="gender" class="form-control" placeholder="Gender" required="">
                            Female<input type="Radio" name="gender" class="form-control" placeholder="Gender" required="">
