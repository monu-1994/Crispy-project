...
<html lang="en">
<head>
<title>Veggie Restaurant Category Flat Bootstrap Responsive Website Template | Services :: W3layouts</title>
<!-- for-mobile-apps -->
...
<section class="services-inner py-5">
	<div class="container py-md-3">
		<h2 class="heading text-center mb-sm-5 mb-4">Our</h2>
	...
	<div class="container py-lg-5 py-sm-3">
		<div class="row join_grids">
			...
			<div class="col-lg-6">
				...
				<a class="btn btn-banner text-capitalize" href="#" role="button">Call Now</a>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container py-sm-3">
		<div class="row footer-grids">
			<div class="col-lg-3 col-sm-6 mb-lg-0 mb-sm-5 mb-4">
				<h4 class="mb-4"><span class="fa fa-cutlery"></span> Veggie</h4>
...
<div class="copyright">
	<div class="container py-4">
		<div class=" text-center">
			<p>© 2019 Veggie. All Rights Reserved | Design by <a href="http://w3layouts.com/"> W3layouts</a> </p>
		</div>
	</div>
</div>
<!-- //copyright -->
